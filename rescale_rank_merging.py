...
def main():
    ...
    parser.add_argument("--rescale", type=float, default=0.9)
    ...
    for module in sd_base.keys():
        ...
        DARE_sd_model1[module] = (m1_delta * args.rescale) + sd_base[module]

        DARE_sd_model2[module] = (m2_delta * args.rescale) + sd_base[module]
